...
function SheetBackdrop({ className, ...props }: SheetPrimitive.Backdrop.Props) {
	return (
		<SheetPrimitive.Backdrop
			...
			className={cn(
				'fixed inset-0 z-50 bg-black/32 backdrop-blur-sm transition-all duration-100 data-ending-style:opacity-0 data-starting-style:opacity-0',
				className
			)}
			{...props}
		/>
	...
	return (
		<SheetPortal>
			...
			<SheetPrimitive.Popup
				...
				className={cn(
					'fixed z-50 flex h-[100dvh] flex-col gap-4 bg-popover text-popover-foreground shadow-lg transition-[opacity,translate] duration-150 ease-in-out will-change-transform',
					side === 'right' &&
